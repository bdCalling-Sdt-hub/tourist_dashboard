...
const Login = () => {
  ...
  return (
    <div className="h-screen w-full center-center bg-[var(--color-blue-500)]">
      {isLoading && <Loading />}
      <Form
        className="max-w-[550px] w-full bg-[var(--color-white)] p-10 py-20 rounded-md card-shadow"
        layout="vertical"
        ...
        {LoginFields?.map((item) => {
          return (
            ...
            >
              <Input
                className="input"
                type={password_type || item?.type}
                placeholder={item?.placeholder}
                suffix={
                  item?.name === "password" ? (
                    password_type ? (
                      <FaEye
                        className="text-lg hover:scale-105 active:scale-95 cursor-pointer"
                        onClick={() => {
                      ...
                      <FaEyeSlash
                        className="text-lg hover:scale-105 active:scale-95 cursor-pointer placeholder:opacity-60"
                        onClick={() => {
        ...
        <Form.Item name={`remember`}>
          <div className=" between-center">
            <div className="start-center w-fit  gap-2">
              ...
              />
              <label
                className="text-[var(--color-gray)] ml-1 cursor-pointer"
                htmlFor="checkbox"
              >
                Remember Password
              </label>
