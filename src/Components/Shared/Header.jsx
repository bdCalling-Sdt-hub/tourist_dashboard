...
const Header = () => {
    ...
    return (
        <div className='bg-[var(--color-blue-500)] end-center h-[110px] px-4 gap-6'>
            ...
            <div onClick={() => navigate('/profile')} className='center-center gap-2 px-3 w-fit py-1 border border-[var(--bg-white)] rounded-md cursor-pointer'>
                <img className='w-10 h-10 rounded-full object-cover' src={data?.data?.profile_image ? `${url}/${data?.data?.profile_image}` : profile} alt="" />
