...
import { Form, Input, DatePicker, TimePicker, Select, Upload, Modal, Checkbox } from 'antd';
...
import { useCreateEventMutation, useUpdateEventsMutation } from '../../Redux/Apis/eventApis';
            ...
            <Form form={form} className='grid-2' layout="vertical" onFinish={onFinish}>
                ...
                >
                    <Select
                        ...
                        options={category?.data?.map((item) => ({ label: item?.name, value: item?._id })) || []}
                    />
                </Form.Item>
                <Form.Item
                    label="Date"
                ...
                </div>
                {
                    ...
                    >
                        <Select
                            ...
                            className=""
                            placeholder="Select Category"
                            options={vendors?.data?.result?.map((item) => ({ label: item?.name, value: item?._id })) || []}
                        />
                    </Form.Item>
                }
