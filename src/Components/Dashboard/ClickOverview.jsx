...
import { useGetClickOverviewQuery } from '../../Redux/Apis/dashboardApi';
...
const ClickOverview = () => {
        ...
        datasets: [
            {
                ...
                // data: [],
                data: Overview?.data?.clickOverview ? [...Overview?.data?.clickOverview] : [],
    ...
    const growthData = [
        {
            name: 'Yearly Growth',
            total: `${Overview?.data?.yearlyGrowth || 0}`
        },
        {
            name: 'Monthly',
            total: `${Overview?.data?.monthlyGrowth || 0}`
        },
        {
            name: 'Day',
            total: `${Overview?.data?.dailyGrowth || 0}`
        },
    ]
    //handler
    return (
